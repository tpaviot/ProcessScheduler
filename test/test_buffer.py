...
def test_objective_maximize_max_buffer_level_2() -> None:
    """many more tasks"""
    pb = ps.SchedulingProblem(name="ObjectiveMaximizeMaxBufferLevelNTasks")
    N = 10
    # two tasks, one loads one unloads
...
def test_objective_minimize_max_buffer_level_1() -> None:
    ...
    pb = ps.SchedulingProblem(name="ObjectiveMinimizeMaxBufferLevel1")
